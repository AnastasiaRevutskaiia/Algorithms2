...
public class BoggleBoard {
    ...
    /**
     * Unit tests the assignment4.BoggleBoard data type.
     */
    public static void main(String[] args) throws URISyntaxException {
        ...
        String path = Paths.get(BoggleBoard.class.getClassLoader()
                .getResource("assignment4/" + filename).toURI()).toString();

        BoggleBoard board4 = new BoggleBoard(path);
